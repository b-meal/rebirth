...
import { PhotoField } from "../../web/components/ui/photo-field";
...
function Demo({ maxCount, disabled, hint }: DemoProps) {
  ...
  return (
    <VStack align="stretch" gap="x4" maxWidth="420px">
      <PhotoField picker={picker} disabled={disabled} hint={hint} />
