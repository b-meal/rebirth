...
// 보호소 사진 81 장에 사람들이 실제로 폰으로 찍어 올린 사진 59 장을 더하고
// 동물이 없는 사진 29 장을 세워 잰 결과 오거부 0, 오입력 검출 26/29
// 안전 구간은 0.2030~0.2613 이고 문턱은 그 안에서 통과 쪽으로 기울여 둠
...
export const ANIMAL_THRESHOLD = 0.22;
...
// 실측으로 이 사진들의 점수가 0.03~0.29 에서 0.80~0.99 로 올라가고 안전 구간은 17 배 넓어짐
// 이불 위 고양이나 대야 속 강아지처럼 동물이 큰 면에 놓인 사진이 여기에 걸림
