...
// 축에서 오른쪽으로 2.5 옮기고 끝을 1.5 더 뽑음, 실기기에서 눈으로 맞춘 값
// 모서리는 clip-path 로는 둥글릴 수 없어 SVG 의 round join 을 씀, 색은 CSS 가 넣음
const ARROW_SVG = [
  '<svg viewBox="0 0 48 48" aria-hidden="true">',
  '<path class="rebirth-my-location-heading-edge" d="M20.5 21.5 L26.5 9.6 L32.5 21.5" stroke-width="2.4" stroke-linejoin="round" stroke-linecap="round" fill="none"/>',
  '<path d="M26.5 9.6 L32.5 21.5 A6.5 6.5 0 0 0 20.5 21.5 Z" stroke="none"/>',
  "</svg>",
].join("");
